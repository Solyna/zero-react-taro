...
export const Label = TaroLabel as JSX.Element | any;
export const Switch = TaroSwitch as JSX.Element | any;
export const Slider = TaroSlider as JSX.Element | any;
export const Picker = TaroPicker as JSX.Element | any;
